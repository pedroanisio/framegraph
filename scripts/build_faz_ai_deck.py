...
def chrome_objects(
    *,
    ...
    return [
        # background
        {"type": "rect", "id": "bg", "decorative": True,
         "box": [0, 0, CANVAS_W, CANVAS_H], "fill": "slide_bg"},
        # top accent rule
        {"type": "rect", "id": "top_rule", "decorative": True,
         "box": [0, 0, CANVAS_W, 4], "fill": "accent"},
        # eyebrow
        {"type": "text", "id": "eyebrow", "decorative": True,
         "box": [LEFT, 14, RIGHT - LEFT, 16],
         "text": eyebrow, "style": "eyebrow"},
        # title
        {"type": "text", "id": "title", "decorative": True,
         "box": [LEFT, 32, RIGHT - LEFT, 30],
         "text": title, "style": "slide_title"},
        # title rule
        {"type": "line", "id": "title_rule", "decorative": True,
         "from": [LEFT, 70], "to": [RIGHT, 70],
         "stroke": {"color": "chrome_line", "width": 0.5}},
        # footer rule
        {"type": "line", "id": "footer_rule", "decorative": True,
         "from": [LEFT, FOOTER_Y - 4], "to": [RIGHT, FOOTER_Y - 4],
         "stroke": {"color": "chrome_line", "width": 0.5}},
        # brand
        {"type": "text", "id": "brand", "decorative": True,
         "box": [LEFT, FOOTER_Y, 200, 14],
         "text": "faz.ai · Manifesto v0.2", "style": "chrome_brand"},
        # page num
        {"type": "text", "id": "pgnum", "decorative": True,
         "box": [RIGHT - 80, FOOTER_Y, 80, 14],
         "text": slide_num, "style": "chrome_num"},
    ]
...
def slide_cover(workbook: dict[str, Any]) -> dict[str, Any]:
    ...
    objs = [
        {"type": "rect", "id": "bg", "decorative": True,
         "box": [0, 0, CANVAS_W, CANVAS_H], "fill": "primary"},
        {"type": "rect", "id": "accent_band", "decorative": True,
         "box": [0, 0, CANVAS_W, 6], "fill": "accent"},
        {"type": "text", "id": "eyebrow", "decorative": True,
         "box": [LEFT, 124, RIGHT - LEFT, 18],
         "text": "Formal Specification", "style": "cover_eyebrow"},
        {"type": "text", "id": "title", "decorative": True,
         "box": [LEFT, 162, RIGHT - LEFT, 92],
         "text": workbook.get("name", "faz.ai Core"),
         "style": "cover_title"},
        {"type": "line", "id": "div", "decorative": True,
         "from": [LEFT, 282], "to": [LEFT + 80, 282],
        ...
        {"type": "text", "id": "footer", "decorative": True,
...
def slide_toc(sections: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for i, sec in enumerate(sections):
        ...
        objs.extend([
            {"type": "rect", "id": f"toc_card_{i}_bg",
             "box": [x, y, col_w, row_h],
             "fill": "panel_bg",
             "stroke": {"color": "chrome_line", "width": 0.5},
             "radius": 4},
            {"type": "text", "id": f"toc_card_{i}_num",
             "box": [x + 12, y + 10, 36, 28],
             "text": f"{num:02d}", "style": "toc_num"},
            {"type": "text", "id": f"toc_card_{i}_title",
             "box": [x + 12, y + 44, col_w - 24, 56],
             "text": title, "style": "toc_title"},
        ])
    return {
        "slide": 2,
        "id": "s02_toc",
...
def slide_diagnostic(section: dict[str, Any]) -> dict[str, Any]:
    ...
    # Three stat cards
    findings = [
        ("47s", "Average focused attention",
         "before context switch", "Mark, UC Irvine 2023"),
        ("95%", "Of enterprise AI pilots",
         "without measurable ROI", "MIT NANDA 2025"),
        ("19%", "Developer slowdown with AI",
         "while believing they were 20% faster", "METR 2025"),
    ]
    ...
    for i, (stat, label, sub, source) in enumerate(findings):
        x = LEFT + i * (card_w + 16)
        objs.extend([
            {"type": "rect", "id": f"card_{i}_bg",
             "box": [x, card_y, card_w, card_h],
             "fill": "panel_bg",
             "stroke": {"color": "chrome_line", "width": 0.5},
             "radius": 4},
            {"type": "rect", "id": f"card_{i}_accent",
             "box": [x, card_y, card_w, 4], "fill": "accent_warm"},
            {"type": "text", "id": f"card_{i}_stat",
             "box": [x + 16, card_y + 28, card_w - 32, 84],
             "text": stat, "style": "stat_huge"},
            {"type": "text", "id": f"card_{i}_label",
             "box": [x + 16, card_y + 122, card_w - 32, 32],
             "text": label, "style": "stat_label"},
            {"type": "text", "id": f"card_{i}_sub",
             "box": [x + 16, card_y + 158, card_w - 32, 56],
             "text": sub, "style": "stat_sub"},
            {"type": "text", "id": f"card_{i}_source",
             "box": [x + 16, card_y + card_h - 36, card_w - 32, 14],
             "text": source, "style": "stat_source"},
        ])
    # Synthesis bar
    objs.extend([
        {"type": "rect", "id": "synth_bg",
         "box": [LEFT, card_y + card_h + 12, RIGHT - LEFT, 38],
         "fill": "primary"},
        {"type": "text", "id": "synth_text",
...
def _principle_card(
    *,
    ...
    return [
        {"type": "rect", "id": f"p{idx}_bg",
         "box": [x, y, w, h],
         "fill": "panel_bg",
         "stroke": {"color": "chrome_line", "width": 0.5},
         "radius": 6},
        {"type": "rect", "id": f"p{idx}_band",
         "box": [x, y, 4, h], "fill": "accent_warm"},
        {"type": "text", "id": f"p{idx}_name",
         "box": [x + 18, y + 14, w - 36, 18],
         "text": name, "style": "principle_name"},
        {"type": "text", "id": f"p{idx}_statement",
         "box": [x + 18, y + 38, w - 36, h - 56],
         "text": statement, "style": "principle_body"},
    ]


def slide_rejection(
    section: dict[str, Any], primitives: dict[str, Any],
    contains: dict[str, list[tuple[int, str]]],
) -> dict[str, Any]:
    """Slide 4 — section 2: three principle cards."""
    fv = section["field_values"]
    principles = section_children(
        section["id"], primitives, contains, type_filter="fs:Principle"
    )
    objs: list[dict[str, Any]] = chrome_objects(
        slide_num="04 / 12",
    ...
    for i, p in enumerate(principles[:3]):
        x = LEFT + i * (card_w + 16)
        objs.extend(_principle_card(
            x=x, y=card_y, w=card_w, h=card_h, idx=i,
...
def slide_reframe(section: dict[str, Any]) -> dict[str, Any]:
    ...
    x2 = LEFT + col_w + 24
    objs.extend([
        {"type": "rect", "id": "after_bg",
         "box": [x2, col_y, col_w, col_h],
         "fill": "primary"},
        {"type": "rect", "id": "after_band",
         "box": [x2, col_y, 4, col_h], "fill": "accent"},
        {"type": "text", "id": "after_label",
         "box": [x2 + 16, col_y + 14, col_w - 32, 16],
         "text": "THE CORE INVERTS THIS", "style": "compare_label"},
        {"type": "text", "id": "after_headline",
         "box": [x2 + 16, col_y + 36, col_w - 32, 48],
         "text": "Achievement is the product.",
         "style": "compare_headline"},
        {"type": "text", "id": "after_body",
...
def slide_commitments(
    ...
    commitments = [
        ...
        ("04", "Refusal as Feature",
         "AI says No. No is No. The cascade does not relent."),
    ]
    ...
    for i, (num, label, body) in enumerate(commitments):
        ...
        objs.extend([
            {"type": "rect", "id": f"c{i}_bg",
             "box": [x, y, card_w, card_h],
             "fill": "panel_bg",
             "stroke": {"color": "chrome_line", "width": 0.5},
             "radius": 4},
            {"type": "text", "id": f"c{i}_num",
             "box": [x + 16, y + 14, 32, 24],
             "text": num, "style": "commit_num"},
            {"type": "line", "id": f"c{i}_div",
             "from": [x + 56, y + 18], "to": [x + 56, y + 38],
             "stroke": {"color": "accent_warm", "width": 2}},
            {"type": "text", "id": f"c{i}_label",
             "box": [x + 64, y + 14, card_w - 80, 24],
             "text": label, "style": "commit_label"},
            {"type": "text", "id": f"c{i}_body",
             "box": [x + 16, y + 50, card_w - 32, card_h - 64],
             "text": body, "style": "commit_body"},
        ])
    return {
        "slide": 6,
        "id": "s06_commitments",
...
def slide_relationship(
    ...
    for i, (layer_label, name, _formal, body, kind_label) in enumerate(layers):
        ...
        objs.extend([
            {"type": "rect", "id": f"l{i}_bg",
             "box": [LEFT, y, RIGHT - LEFT, band_h],
             "fill": fills[i]},
            {"type": "text", "id": f"l{i}_layer",
             "box": [LEFT + 18, y + 14, 90, 16],
             "text": layer_label, "style": "layer_label"},
            {"type": "text", "id": f"l{i}_name",
             "box": [LEFT + 18, y + 36, 200, 36],
             "text": name, "style": "layer_name"},
            {"type": "text", "id": f"l{i}_kind",
             "box": [LEFT + 18, y + 80, 220, 18],
             "text": kind_label.upper(), "style": "layer_kind"},
            {"type": "text", "id": f"l{i}_body",
             "box": [LEFT + 240, y + 18, RIGHT - LEFT - 256, band_h - 32],
             "text": body, "style": "layer_body"},
        ])
    return {
        "slide": 7,
        "id": "s07_structure",
...
def slide_cascade(
    ...
    for i, (def_id, num, short) in enumerate(layers):
        ...
        # number bubble
        objs.extend([
            {"type": "rect", "id": f"r{i}_num_bg",
             "box": [LEFT, y, num_w, row_h],
             "fill": "primary"},
            {"type": "text", "id": f"r{i}_num",
             "box": [LEFT, y + 14, num_w, 28],
             "text": num, "style": "cascade_num"},
            # short label
            {"type": "rect", "id": f"r{i}_label_bg",
             "box": [LEFT + num_w, y, label_w, row_h],
             "fill": "panel_bg",
             "stroke": {"color": "chrome_line", "width": 0.5}},
            {"type": "text", "id": f"r{i}_label",
             "box": [LEFT + num_w + 12, y + 12, label_w - 24, 18],
             "text": short, "style": "cascade_short"},
            {"type": "text", "id": f"r{i}_informal",
             "box": [LEFT + num_w + 12, y + 32, label_w - 24, 18],
             "text": d.get("informal", "")[:48], "style": "cascade_informal"},
            # body
            {"type": "rect", "id": f"r{i}_body_bg",
             "box": [body_x, y, body_w, row_h],
             "fill": "panel_bg",
             "stroke": {"color": "chrome_line", "width": 0.5}},
            {"type": "text", "id": f"r{i}_body",
             "box": [body_x + 12, y + 8, body_w - 24, row_h - 16],
             "text": d.get("formal", "")[:240], "style": "cascade_body"},
        ])
...
def slide_voice(
    ...
    states = [
        ("def:UI_FRAGMENTED_DEFAULT", "FRAGMENTED",
         "Three threads in flight. faz is keeping context warm."),
        ("def:UI_DEPLETED", "DEPLETED",
         "You've done enough thinking today."),
        ("def:UI_RESTING", "RESTING",
         "faz is working. You are resting."),
        ("def:UI_OVERLOADED", "OVERLOADED",
         "Take a breath. faz triaged the rest."),
    ]
    card_w = (RIGHT - LEFT - 16) // 2
    card_h = 156
    grid_y = 138
    for i, (def_id, label, quote) in enumerate(states):
        ...
        y = grid_y + row * (card_h + 16)
        objs.extend([
            {"type": "rect", "id": f"u{i}_bg",
             "box": [x, y, card_w, card_h],
             "fill": "panel_bg",
             "stroke": {"color": "chrome_line", "width": 0.5},
             "radius": 4},
            {"type": "rect", "id": f"u{i}_band",
             "box": [x, y, 4, card_h], "fill": "accent_warm"},
            {"type": "text", "id": f"u{i}_label",
             "box": [x + 18, y + 14, card_w - 36, 16],
             "text": f"UI · {label}", "style": "ui_label"},
            {"type": "text", "id": f"u{i}_quote",
             "box": [x + 18, y + 38, card_w - 36, 56],
             "text": f"“{quote}”", "style": "ui_quote"},
            {"type": "text", "id": f"u{i}_gloss",
             "box": [x + 18, y + 100, card_w - 36, card_h - 112],
             "text": d.get("informal", "")[:160], "style": "ui_gloss"},
        ])
    return {
        "slide": 9,
        "id": "s09_voice",
...
def slide_taboos(
    ...
    fv = section["field_values"]
    invariants = section_children(
        section["id"], primitives, contains, type_filter="fs:Invariant"
    )
    objs: list[dict[str, Any]] = chrome_objects(
        slide_num="10 / 12",
    ...
    for i, inv in enumerate(invariants[:6]):
        ...
        objs.extend([
            {"type": "rect", "id": f"inv{i}_bg",
             "box": [LEFT, y, RIGHT - LEFT, item_h],
             "fill": "panel_bg",
             "stroke": {"color": "chrome_line", "width": 0.5}},
            {"type": "rect", "id": f"inv{i}_band",
             "box": [LEFT, y, 6, item_h], "fill": "danger"},
            # NO badge
            {"type": "text", "id": f"inv{i}_badge",
             "box": [LEFT + 18, y + 18, 36, 14],
             "text": "NO ·", "style": "taboo_badge"},
            {"type": "text", "id": f"inv{i}_name",
             "box": [LEFT + 60, y + 8, 320, 16],
             "text": name, "style": "taboo_name"},
            {"type": "text", "id": f"inv{i}_statement",
             "box": [LEFT + 60, y + 26, RIGHT - LEFT - 80, item_h - 30],
             "text": statement[:200], "style": "taboo_statement"},
        ])
    return {
        "slide": 10,
        "id": "s10_taboos",
...
def slide_closing(
    ...
    objs: list[dict[str, Any]] = [
        ...
        {"type": "text", "id": "label", "decorative": True,
        ...
        {"type": "text", "id": "the_sentence", "decorative": True,
        ...
        {"type": "text", "id": "rule", "decorative": True,
...
def slide_colophon(workbook: dict[str, Any], counts: dict[str, Any]) -> dict[str, Any]:
    ...
    for i, (label, value) in enumerate(rows):
        y = grid_y + i * row_h
        objs.extend([
            {"type": "text", "id": f"col_{i}_label",
             "box": [LEFT, y + 8, label_w, 18],
             "text": label.upper(), "style": "colophon_label"},
            {"type": "text", "id": f"col_{i}_value",
             "box": [LEFT + label_w + 16, y + 8, RIGHT - LEFT - label_w - 16, 18],
             "text": value, "style": "colophon_value"},
            {"type": "line", "id": f"col_{i}_rule",
             "from": [LEFT, y + row_h], "to": [RIGHT, y + row_h],
             "stroke": {"color": "chrome_line", "width": 0.5}},
        ])
    objs.append({
        "type": "text", "id": "tagline", "decorative": True,
...
def text_styles() -> dict[str, dict[str, Any]]:
    ...
    return {
        # chrome
        "eyebrow": {"font": "primary", "size": 10, "weight": 700,
                    "color": "accent_warm", "align": "left"},
        "slide_title": {"font": "primary", "size": 22, "weight": 700,
                        "color": "primary", "align": "left"},
        "chrome_brand": {"font": "primary", "size": 9, "weight": 700,
                         "color": "primary", "align": "left"},
        "chrome_num": {"font": "primary", "size": 9, "weight": 400,
                       "color": "text_muted", "align": "right"},
        "lede": {"font": "primary", "size": 13, "weight": 400,
                 "color": "text_muted", "align": "left", "line_height": 18},

        # cover
        "cover_eyebrow": {"font": "primary", "size": 11, "weight": 700,
                          "color": "accent", "align": "left"},
        "cover_title": {"font": "primary", "size": 38, "weight": 700,
                        "color": "white", "align": "left", "line_height": 46,
                        "wrap": True},
        "cover_subtitle": {"font": "primary", "size": 13, "weight": 400,
                           "color": "text_muted_light", "align": "left",
                           "line_height": 20, "wrap": True},
        "cover_footer": {"font": "primary", "size": 9, "weight": 400,
                         "color": "text_muted_light", "align": "left"},

        # toc
        "toc_num": {"font": "primary", "size": 22, "weight": 700,
                    "color": "accent_warm", "align": "left"},
        "toc_title": {"font": "primary", "size": 12, "weight": 700,
                      "color": "primary", "align": "left", "line_height": 16,
                      "wrap": True},

        # diagnostic stat cards
        "stat_huge": {"font": "primary", "size": 60, "weight": 700,
                      "color": "primary", "align": "left", "line_height": 70},
        "stat_label": {"font": "primary", "size": 13, "weight": 700,
                       "color": "primary", "align": "left", "line_height": 18,
                       "wrap": True},
        "stat_sub": {"font": "primary", "size": 11, "weight": 400,
                     "color": "text_muted", "align": "left", "line_height": 16,
                     "wrap": True},
        "stat_source": {"font": "primary", "size": 9, "weight": 400,
                        "color": "text_muted", "align": "left",
                        "italic": True},
        "synth": {"font": "primary", "size": 12, "weight": 700,
                  "color": "white", "align": "left", "line_height": 16},

        # principle cards
        "principle_name": {"font": "primary", "size": 11, "weight": 700,
                           "color": "accent_warm", "align": "left"},
        "principle_body": {"font": "primary", "size": 13, "weight": 400,
                           "color": "primary", "align": "left",
                           "line_height": 19, "wrap": True},

        # reframe (compare)
        "compare_label": {"font": "primary", "size": 10, "weight": 700,
                          "color": "accent", "align": "left"},
        "compare_label_dim": {"font": "primary", "size": 10, "weight": 700,
                              "color": "text_muted", "align": "left"},
        "compare_headline": {"font": "primary", "size": 26, "weight": 700,
                             "color": "white", "align": "left",
                             "line_height": 32, "wrap": True},
        "compare_headline_dim": {"font": "primary", "size": 26, "weight": 700,
                                 "color": "primary", "align": "left",
                                 "line_height": 32, "wrap": True},
        "compare_body": {"font": "primary", "size": 12, "weight": 400,
                         "color": "text_muted_light", "align": "left",
                         "line_height": 18, "wrap": True},
        "compare_body_dim": {"font": "primary", "size": 12, "weight": 400,
                             "color": "text_muted", "align": "left",
                             "line_height": 18, "wrap": True},

        # commitments
        "commit_num": {"font": "primary", "size": 22, "weight": 700,
                       "color": "accent_warm", "align": "left"},
        "commit_label": {"font": "primary", "size": 14, "weight": 700,
                         "color": "primary", "align": "left",
                         "line_height": 20, "wrap": True},
        "commit_body": {"font": "primary", "size": 12, "weight": 400,
                        "color": "text_muted", "align": "left",
                        "line_height": 17, "wrap": True},

        # relationship layers
        "layer_label": {"font": "primary", "size": 10, "weight": 700,
                        "color": "accent", "align": "left"},
        "layer_name": {"font": "primary", "size": 26, "weight": 700,
                       "color": "white", "align": "left"},
        "layer_kind": {"font": "primary", "size": 10, "weight": 700,
                       "color": "text_muted_light", "align": "left"},
        "layer_body": {"font": "primary", "size": 12, "weight": 400,
                       "color": "text_muted_light", "align": "left",
                       "line_height": 17, "wrap": True},

        # cascade
        "cascade_num": {"font": "primary", "size": 22, "weight": 700,
                        "color": "white", "align": "center"},
        "cascade_short": {"font": "primary", "size": 12, "weight": 700,
                          "color": "primary", "align": "left"},
        "cascade_informal": {"font": "primary", "size": 10, "weight": 400,
                             "color": "text_muted", "align": "left"},
        "cascade_body": {"font": "primary", "size": 10, "weight": 400,
                         "color": "primary", "align": "left",
                         "line_height": 14, "wrap": True},
        "tier_num_white": {"font": "primary", "size": 10, "weight": 700,
                           "color": "white", "align": "left"},
        "tier_label_white": {"font": "primary", "size": 13, "weight": 700,
                             "color": "white", "align": "left"},
        "tier_num_primary": {"font": "primary", "size": 10, "weight": 700,
                             "color": "primary", "align": "left"},
        "tier_label_primary": {"font": "primary", "size": 13, "weight": 700,
                               "color": "primary", "align": "left"},

        # voice / UI states
        "ui_label": {"font": "primary", "size": 10, "weight": 700,
                     "color": "accent_warm", "align": "left"},
        "ui_quote": {"font": "primary", "size": 17, "weight": 700,
                     "color": "primary", "align": "left",
                     "line_height": 24, "italic": True, "wrap": True},
        "ui_gloss": {"font": "primary", "size": 11, "weight": 400,
                     "color": "text_muted", "align": "left",
                     "line_height": 16, "wrap": True},

        # taboos
        "taboo_badge": {"font": "primary", "size": 10, "weight": 700,
                        "color": "danger", "align": "left"},
        "taboo_name": {"font": "primary", "size": 12, "weight": 700,
                       "color": "primary", "align": "left"},
        "taboo_statement": {"font": "primary", "size": 10, "weight": 400,
                            "color": "text_muted", "align": "left",
                            "line_height": 14, "wrap": True},

        # closing
        "closing_eyebrow": {"font": "primary", "size": 11, "weight": 700,
                            "color": "accent", "align": "left"},
        "closing_label": {"font": "primary", "size": 11, "weight": 700,
                          "color": "text_muted_light", "align": "left"},
        "closing_sentence": {"font": "primary", "size": 44, "weight": 700,
                             "color": "white", "align": "center",
                             "line_height": 56, "wrap": True},
        "closing_rule": {"font": "primary", "size": 13, "weight": 400,
                         "color": "text_muted_light", "align": "center",
                         "line_height": 19, "wrap": True},
        "closing_footer": {"font": "primary", "size": 9, "weight": 400,
                           "color": "text_muted_light", "align": "left"},

        # colophon
        "colophon_label": {"font": "primary", "size": 10, "weight": 700,
                           "color": "accent_warm", "align": "left"},
        "colophon_value": {"font": "primary", "size": 12, "weight": 400,
                           "color": "primary", "align": "left"},
        "colophon_tagline": {"font": "primary", "size": 10, "weight": 400,
                             "color": "text_muted", "align": "left",
                             "italic": True},
    }
